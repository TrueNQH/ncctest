function Contact() {
    return(
        ...
        <div class="grid wide">
          <div class="wrap row">
            <div class="col l-12 c-12 m-12 logo-company">
              <img src="./image/logoncc.png" alt="" />
            </div>
            ...
            <div class="wrap-title">
              ...
              <p>
                ...
                vestibulum. Phasellus congue mollis orci, sit amet luctus
                augue tristique eu. Donec vulputate odio neque, sed semper
                turpis pellentesque a.
              </p>
            </div>
          </div>
          <div class="row">
            <div class="col l-4 c-12 m-12 item">
              <p>
                <img class="logo-item" src="../image/cssicon.png" alt="" />
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
            ...
            <div class="col l-4 item">
              <p>
                <img class="logo-item" src="../image/htmlicon.png" alt="" />
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
                non dui sodales, faucibus libero ut, posuere felis. Donec
                imperdiet suscipit accumsan. Aenean consequat condimentum
                velit ut tempor. Nam porta massa in metus bibendum congue.
            ...
            <div class="col l-4 item">
              <p>
                <img class="logo-item" src="../image/urlicon.png" alt="" />
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
                non dui sodales, faucibus libero ut, posuere felis. Donec
                imperdiet suscipit accumsan. Aenean consequat condimentum
                velit ut tempor. Nam porta massa in metus bibendum congue.
